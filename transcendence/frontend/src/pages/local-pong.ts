...
//     const ballSpeed = BALL_SPEED; // Ball speed
...
//     const visualSpeed = Math.sqrt(gameState.ball.dx ** 2 + gameState.ball.dy ** 2) * BALL_SPEED;
//     ctx.font = '12px Arial';
//     ctx.fillStyle = '#666666';
//     ctx.textAlign = 'center';
//     ctx.fillText(`Speed: ${visualSpeed.toFixed(1)}`, canvas.width / 2, canvas.height - 5);
